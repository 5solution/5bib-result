...
export interface GivFunInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
  ...
  encodeFunctionData(functionFragment: "updateImage", values: [string]): string;
  encodeFunctionData(
...
export namespace UpdateImageEvent {
...
export namespace UpdateMetadataEvent {
  export type InputTuple = [metadata: string];
...
export namespace VerifiedEvent {
  export type InputTuple = [admin: AddressLike, token: AddressLike];
  export type OutputTuple = [admin: string, token: string];
  export interface OutputObject {
    admin: string;
    token: string;
  }
...
export interface GivFun extends BaseContract {
  connect(runner?: ContractRunner | null): GivFun;
  waitForDeployment(): Promise<this>;

  interface: GivFunInterface;
  ...
  context: TypedContractMethod<[], [string], "view">;
  ...
  updateImage: TypedContractMethod<[image_: string], [void], "nonpayable">;
  ...
  verify: TypedContractMethod<[], [void], "nonpayable">;
  ...
  >;
  getFunction(
    nameOrSignature: "updateImage"
  ): TypedContractMethod<[image_: string], [void], "nonpayable">;
  getFunction(
  ...
  getEvent(
    ...
    UpdateImageEvent.InputTuple,
    UpdateImageEvent.OutputTuple,
    UpdateImageEvent.OutputObject
  >;
  getEvent(
    key: "UpdateMetadata"
  ): TypedContractEvent<
    UpdateMetadataEvent.InputTuple,
    UpdateMetadataEvent.OutputTuple,
    UpdateMetadataEvent.OutputObject
  >;
  getEvent(
    key: "Verified"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "UpdateImage(string)": TypedContractEvent<
      UpdateImageEvent.InputTuple,
      UpdateImageEvent.OutputTuple,
      UpdateImageEvent.OutputObject
    >;
    UpdateImage: TypedContractEvent<
      UpdateImageEvent.InputTuple,
      UpdateImageEvent.OutputTuple,
      UpdateImageEvent.OutputObject
    >;

    "UpdateMetadata(string)": TypedContractEvent<
      UpdateMetadataEvent.InputTuple,
      UpdateMetadataEvent.OutputTuple,
      UpdateMetadataEvent.OutputObject
    >;
    UpdateMetadata: TypedContractEvent<
      UpdateMetadataEvent.InputTuple,
      UpdateMetadataEvent.OutputTuple,
      UpdateMetadataEvent.OutputObject
    >;

    "Verified(address,address)": TypedContractEvent<
      VerifiedEvent.InputTuple,
      VerifiedEvent.OutputTuple,
      VerifiedEvent.OutputObject
    >;
