...
## In Progress
- [ ] [HIGH] Thêm phần sponsor cho từng giải cấu hình cho từng giải ở cả admin, và hiển thị trên client, kiểm tra backend xem có chưa. Hiện logo của sponsor ở phần kết quả races/cao-bang-2025/ranking/10km, to đùng bên dưới cùng của ranking
