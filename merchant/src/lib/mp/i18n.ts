...
export const DICT: Dict = {
  ...
  kpi_cancelled: { vi: "Số vé hủy", en: "Cancelled tickets", km: "សំបុត្របានលុបចោល", lo: "ປີ້ທີ່ຍົກເລີກ", ms: "Tiket dibatalkan" },
  kpi_import: { vi: "Số vé import", en: "Imported tickets", km: "សំបុត្រនាំចូល", lo: "ປີ້ນຳເຂົ້າ", ms: "Tiket diimport" },
  kpi_sold: { vi: "Số vé đã bán", en: "Tickets sold", km: "សំបុត្រលក់បាន", lo: "ປີ້ທີ່ຂາຍ", ms: "Tiket terjual" },
  kpi_total_all: { vi: "Tổng số vé", en: "Total tickets", km: "សំបុត្រសរុប", lo: "ປີ້ທັງໝົດ", ms: "Jumlah tiket" },
  src_5bib: { vi: "Qua 5BIB", en: "Via 5BIB", km: "តាមរយៈ 5BIB", lo: "ຜ່ານ 5BIB", ms: "Melalui 5BIB" },
  src_import: { vi: "Import", en: "Import", km: "នាំចូល", lo: "ນຳເຂົ້າ", ms: "Import" },
  via_5bib: { vi: "Đã thu qua 5BIB", en: "Collected via 5BIB", km: "ប្រមូលតាមរយៈ 5BIB", lo: "ເກັບຜ່ານ 5BIB", ms: "Dikutip melalui 5BIB" },
  import_hint: { vi: "Bán nguồn khác, import vào 5BIB", en: "Sold elsewhere, imported into 5BIB", km: "លក់ប្រភពផ្សេង នាំចូល 5BIB", lo: "ຂາຍແຫຼ່ງອື່ນ ນຳເຂົ້າ 5BIB", ms: "Dijual di tempat lain, diimport ke 5BIB" },
  demo_coverage_note: { vi: "Cơ cấu dựa trên {n} vé có dữ liệu — vé import chưa có thông tin chi tiết", en: "Breakdown based on {n} tickets with data — imported tickets lack detail", km: "ផ្អែកលើសំបុត្រ {n} ដែលមានទិន្នន័យ", lo: "ອີງໃສ່ປີ້ {n} ທີ່ມີຂໍ້ມູນ", ms: "Berdasarkan {n} tiket berdata" },
