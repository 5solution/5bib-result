...
export const DICT: Dict = {
  ...
  // F-070 — MKT analytics
  mkt_analytics: { vi: "Phân tích MKT", en: "MKT analytics" },
  forecast_title: { vi: "Lũy kế & dự báo về đích", en: "Pace & projection to race day" },
  heatmap_title: { vi: "Khung giờ vàng đăng ký", en: "Registration time heatmap" },
  funnel_title: { vi: "Phễu chuyển đổi đơn", en: "Order conversion funnel" },
  ticket_target: { vi: "Mục tiêu vé", en: "Ticket target" },
  save: { vi: "Lưu", en: "Save" },
  saving: { vi: "Đang lưu…", en: "Saving…" },
  target_saved: { vi: "Đã lưu mục tiêu", en: "Target saved" },
  target_invalid: { vi: "Mục tiêu phải là số nguyên 0–10.000.000", en: "Target must be an integer 0–10,000,000" },
  vn_hours: { vi: "giờ VN", en: "VN time" },
  race_ended_note: { vi: "Giải đã kết thúc — chỉ hiện lũy kế thực tế", en: "Race ended — showing actual cumulative only" },
  conversion: { vi: "Tỷ lệ chuyển đổi", en: "Conversion" },
  pending_rate: { vi: "Đơn treo", en: "Pending" },
  cancel_rate: { vi: "Huỷ / hoàn", en: "Cancel/refund" },
  orders_created: { vi: "Tổng đơn tạo", en: "Orders created" },
  paid_confirmed: { vi: "Đã thanh toán", en: "Paid / confirmed" },
  insight: { vi: "MKT insight", en: "MKT insight" },
  not_enough_data: { vi: "Chưa đủ dữ liệu", en: "Not enough data" },
  no_reg_data: { vi: "Chưa có dữ liệu đăng ký cho giải này", en: "No registration data for this race" },
  target_label: { vi: "Mục tiêu", en: "Target" },
  race_day: { vi: "Ngày đua", en: "Race day" },
  cumulative_tickets: { vi: "vé lũy kế", en: "cumulative" },
  legend_low: { vi: "Ít", en: "Low" },
  legend_high: { vi: "Nhiều", en: "High" },
