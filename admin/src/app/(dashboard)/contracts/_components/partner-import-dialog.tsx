                  ...
                  <Table className="table-fixed w-full">
                    <TableHeader className="sticky top-0 bg-background z-10">
                      <TableRow>
                        ...
                        <TableHead className="min-w-[200px]">Tên đối tác</TableHead>
                        <TableHead className="w-[120px]">MST</TableHead>
                        <TableHead className="w-[140px]">Đại diện</TableHead>
                ...
                <div className="max-h-[30vh] overflow-auto">
                  <Table className="table-fixed w-full">
                    <TableHeader className="sticky top-0 bg-background z-10">
                      <TableRow>
                        <TableHead className="w-10">#</TableHead>
                        <TableHead className="min-w-[260px]">Tên đối tác</TableHead>
                        <TableHead className="w-[140px]">MST</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {preview.duplicate.map((row) => (
                        <TableRow key={`d-${row.rowNum}`}>
                          ...
                          <TableCell className="truncate" title={row.entityName}>
                            {row.entityName}
                          </TableCell>
                          <TableCell
                            className="font-mono text-xs truncate"
                    ...
                    <TableBody>
                      {preview.invalid.map((row) => {
                        const rawName = String(
                          (row.raw as { entityName?: unknown }).entityName ??
                            "—",
                        );
