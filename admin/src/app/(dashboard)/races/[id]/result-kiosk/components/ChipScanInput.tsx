...
/**
 * F-017 BR-AF-23 BYTE-FOR-BYTE port of frontend ChipInputCapture.
 *
 * Source: `frontend/app/chip-verify/[token]/components/ChipInputCapture.tsx`
 * (Hash anchor: see git blame; logic identical except component name).
 *
 * Edge cases handled:
 ...
 *
 * @see frontend ChipInputCapture for invariants. Diff this file before
 *   modifying — Manager BLOCKING PAUSE point #4 enforces verbatim parity.
 */
...
export function ChipScanInput({ onScan, disabled }: Props) {
