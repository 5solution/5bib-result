        ...
        <div className="relative z-10 flex flex-col h-full p-10 lg:p-14 text-white">
          ...
          <div className="space-y-6 max-w-md">
            <h1 className="text-3xl lg:text-4xl font-black leading-tight tracking-tight">
              Gia nhập cộng đồng
              <br />
              <span className="text-cyan-300">runner Việt Nam</span>
            </h1>
            <p className="text-blue-100/80 text-base leading-relaxed">
              Tạo tài khoản miễn phí trong vài giây để lưu kết quả, theo dõi
              các vận động viên yêu thích và không bỏ lỡ giải đấu nào.
            </p>
