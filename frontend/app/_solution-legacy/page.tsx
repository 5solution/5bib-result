...
import SolutionHeader from '@/components/_solution-legacy/solution-header';
import SolutionHero from '@/components/_solution-legacy/solution-hero';
import { SolutionSocialProof, SolutionPainSolution } from '@/components/_solution-legacy/solution-pain';
import SolutionFeatureTabs from '@/components/_solution-legacy/solution-feature-tabs';
import {
  SolutionHowItWorks,
  SolutionTimeline,
  SolutionComparison,
  ...
  SolutionFinalCTA,
  SolutionFooter,
} from '@/components/_solution-legacy/solution-sections';
import SolutionContactModal from '@/components/_solution-legacy/SolutionContactModal';
import SolutionAnalytics from '@/components/_solution-legacy/SolutionAnalytics';
import type { Lang } from '@/components/_solution-legacy/solution-icons';
