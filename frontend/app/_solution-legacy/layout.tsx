...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/_solution-legacy',
    languages: {
      'vi-VN': '/_solution-legacy',
  ...
  openGraph: {
    ...
    images: [
      {
        url: '/_solution-legacy/brand/5bib-hero.jpg',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['/_solution-legacy/brand/5bib-hero.jpg'],
  },
  // Legacy hidden — keep accessible at /_solution-legacy but invisible to crawlers
  robots: {
    index: false,
    follow: false,
    nocache: true,
  ...
  icons: {
    icon: '/_solution-legacy/logos/5bib-logo.png',
  },
};
...
export default function SolutionLayout({ children }: { children: React.ReactNode }) {
    ...
    '@graph': [
      {
        ...
        name: '5Solution JSC',
        url: 'https://5bib.com',
        logo: 'https://5bib.com/_solution-legacy/logos/5bib-logo.png',
  ...
  return (
    <>
      ...
      <link rel="stylesheet" href="/_solution-legacy/solution.css" />
      <script
