...
export function MagneticText({
  ...
  return (
    ...
    >
      ...
      <span className={cn("inline-block", textClassName)}>{text}</span>

      <div
        ref={circleRef}
        className={cn(
          "pointer-events-none absolute top-0 left-0 overflow-hidden rounded-full",
        ...
        >
          <span
            className={cn(
              ...
              hoverTextClassName ?? textClassName,
            )}
          >
            {hoverText}
          </span>
