 ...
 *
 * Phase 3 copy of `admin/src/components/course-map/ElevationChart.tsx`. Kept
 * byte-identical to the admin version so a future packages/shared extraction
 * is a straight move-and-import. Do not diverge — fix in admin first, then
